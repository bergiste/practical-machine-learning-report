...
My first instinct was that 160 features would not be necessary to make an accurate prediction. One of the first things I noticed immediately was that there were many missing values from the features. Also, I was very curious about the uniqueness of the values in the data.
